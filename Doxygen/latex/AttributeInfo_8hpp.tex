...
\begin{DoxyCompactList}\small\item\em Classe que contém as informações \hyperlink{classLineNumber}{Line\+Number} contendo start\+PC e o line\+Number. \end{DoxyCompactList}\item 
class \hyperlink{classLineNumberTableAttribute}{Line\+Number\+Table\+Attribute}
\begin{DoxyCompactList}\small\item\em Classe que contém as informações \hyperlink{classLineNumberTableAttribute}{Line\+Number\+Table\+Attribute} contendo o tamanho da Line\+Number\+Table e um ponteiro do tipo \hyperlink{classLineNumber}{Line\+Number}. \end{DoxyCompactList}\item 
class \hyperlink{classLocalVariable}{Local\+Variable}
\begin{DoxyCompactList}\small\item\em Classe que contém as características das variáveis locais;. \end{DoxyCompactList}\item 
class \hyperlink{classLocalVariableTableAttribute}{Local\+Variable\+Table\+Attribute}
\begin{DoxyCompactList}\small\item\em Classe que contém as variáves locais na tabela de atributos. \end{DoxyCompactList}\item 
class \hyperlink{classAttributeInfo}{Attribute\+Info}
\begin{DoxyCompactList}\small\item\em Classe que contém as informações dos atributos. \end{DoxyCompactList}\end{DoxyCompactItemize}
